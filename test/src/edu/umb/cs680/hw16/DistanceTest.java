...
public class DistanceTest {
    ...
    public void verifyManhattanDistance2D(){
        ...
        assertEquals(362.0, Distance.get(p1, p2, (point1, point2)->{
    ...
    public void verifyChebyshevDistance2D(){
        ...
        assertEquals(98.0, Distance.get(p1, p2, (point1, point2)->{
            double max=0;
            if (point1.size() == point2.size()){
                double value = 0.0;
                for(int i=0; i < point1.size(); i++) {
    ...
    public void verifyManhattanDistanceMatrix3D(){
        ...
        assertTrue(Arrays.deepEquals(expected.toArray(), Distance.matrix(points, (point1, point2)->{
            if (point1.size() == point2.size()){
                double sum = 0.0;
                for(int i=0; i < point1.size(); i++) {
                    sum += Math.abs(point1.get(i)-point2.get(i));
